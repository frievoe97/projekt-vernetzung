...
const SET_GLOSSARY_TAGS_FROM_SANITY = "SET_GLOSSARY_TAGS_FROM_SANITY";
...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case SET_GLOSSARY_TAGS_FROM_SANITY:
      return { ...state, glossaryTagsFromSanity: action.payload };
    default:
      return state;
  }
};
