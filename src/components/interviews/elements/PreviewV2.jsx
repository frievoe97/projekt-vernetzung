  ...
  return (
    <div className="w-96 h-128 flex flex-col relative rounded-2xl shadow-2xl interview-preview-container">
      <div className="w-full h-40 bg-fm_blau rounded-t-2xl relative overflow-hidden">
        <img
          className="h-48 w-48 object-cover absolute top-1/2 transform -translate-y-1/2 right-10 rounded-full shadow-2xl"
          src={imageUrl}
          alt=""
        />
      </div>
      <div className="p-4 flex flex-col">
        ...
        <p className="text-black font-light mb-4">{textTeaser}</p>
