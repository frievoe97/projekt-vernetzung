...
const ContactBanner = () => {
  return (
    <div className="bg-gradient-to-r from-color_1 via-color_1 to-color_2 text-black p-8 flex flex-col items-center justify-center h-fit shadow-[inset_0px_0px_30px_2px_rgba(0,0,0,0.3)]">
