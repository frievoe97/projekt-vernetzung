...
const AnlaufstellenCard = ({ anlaufstelle }) => {
  return (
    <div
      key={anlaufstelle.id}
      className="p-6 w-full md:w-1/3 lg:w-1/3 xl:w-1/4 border-2 rounded-xl border-black transform hover:scale-105 transition-transform duration-300 hover:shadow-3xl text-color_font"
    >
      ...
      <div className="w-full mb-4">
        <p className="text-justify">{anlaufstelle.description}</p>
